...
import { ConfirmModalComponent } from '../confirm-modal/confirm-modal.component'; // Import the new modal component
...
export class ManageUsersComponent implements OnInit {
  ...
  message: string = ''; // Variable to store messages
  showModal: boolean = false; // Control the visibility of the modal
  showSuccessModal: boolean = false; // Control the visibility of the success modal
  userToDelete: any = null; // Store the user to be deleted
